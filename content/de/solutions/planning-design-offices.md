...
blocks:
  ...
  - type: featureTabs
    title: Gebaut für die Werkzeuge, die Ihr Team schon nutzt, nicht daneben.
    items:
      - label: Ablaufanalyse
        body: >-
      ...
      - label: Plugin-Entwicklung
        ...
        points:
          ...
          - Iterative Entwicklung mit Rückmeldung Ihres Teams in jeder Stufe
        image:
          src: /assets/img/tab-plugin-development.webp
          alt: Entwickler am Schreibtisch mit Plugin-Code auf zwei Bildschirmen
          width: 683
          height: 1024
      - label: Einhaltung von Standards
        body: >-
          Jedes Plugin setzt Ihre Bürostandards durch. Benennungsregeln,
          Layerstrukturen, Planlayouts und Bauteilklassifizierungen stecken in der
          Automatisierungslogik, damit Ihre Ergebnisse über jedes Projekt und jedes
          Teammitglied hinweg einheitlich sind.
        points:
          - Durchsetzung von Benennungs- und Klassifizierungsregeln
          - Einheitliche Ergebnisse, unabhängig davon, wer den Ablauf startet
          - Abgestimmt auf nationale und unternehmenseigene Standards
        image:
          src: /assets/img/tab-standards-compliance.webp
          alt: Zwei Ingenieure prüfen einen Plansatz gegen die geltenden Normen
          width: 1024
          height: 684
      - label: Laufende Aktualisierung
        body: >-
          Der Rollout ist nicht die Ziellinie. Wie sich Ihre Projekte entwickeln,
          entwickeln sich auch die Plugins. Neue Standards, neue Bauteiltypen, neue
          Abläufe. Wir beobachten die Nutzung, sammeln Rückmeldungen und schärfen die
          Automatisierung über die Zeit nach, damit sie zu der Art passt, wie Ihr Büro
          tatsächlich arbeitet.
        points:
          - Laufende Pflege und Verfeinerung nach dem Rollout
          - Kompatibilitätsupdates, wenn sich BIM-Softwareversionen ändern
          - Neue Automatisierungsfunktionen auf Basis echter Nutzungsdaten
        image:
          src: /assets/img/tab-continuous-updates.webp
          alt: Turmdrehkrane über einem Gebäude im Bau
          width: 1024
          height: 684

  - type: faq
    tone: void
    title: Eigene BIM-Plugins, die in Ihrer Planungsumgebung laufen, nicht daneben.
    ...
    items:
      - q: Welche BIM-Plattformen unterstützen Sie?
        a: >-
          Wir bauen Plugins für Revit, Tekla Structures, Allplan und Archicad. Wenn Ihr
          Büro ein anderes Planungswerkzeug nutzt, sagen Sie uns Bescheid. Das Vorgehen
          ist unabhängig von der Plattform dasselbe: wir analysieren zuerst Ihre Abläufe
      ...
      - q: Was passiert, wenn unsere BIM-Software aktualisiert wird?
        a: >-
          ...
          laufenden Betreuung aufrecht. Wenn Autodesk, Trimble oder Nemetschek Updates
          veröffentlichen, testen und aktualisieren wir das Plugin, damit es weiter
          funktioniert. Sie müssen sich keine Sorgen machen, dass ein Update Ihre
          Automatisierung lahmlegt.
      - q: Kann das Plugin projektspezifische Anforderungen abbilden?
        a: >-
      ...
      - title: Strategischer Vorsprung
        body:
          ...
          - >-
            ...
            Über die Zeit summiert sich das zu einem echten Wettbewerbsvorteil.
      - title: Branchen-DNA
        body:
          - >-
            In unserem Team arbeiten Tragwerksplaner, BIM-Fachleute und
