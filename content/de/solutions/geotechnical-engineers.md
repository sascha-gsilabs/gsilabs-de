---
title: Für Geotechnik
description: >-
  Optimieren Sie Ihre Pfahlgründungen auf Materialeffizienz, CO2-Reduktion und
  Normkonformität, mit statistischer Baugrundmodellierung und automatisierter Bewertung.
blocks:
  - type: hero
    eyebrow: Für Geotechnik
    title: Bessere Gründungen
    lede: >-
      Optimieren Sie Ihre Pfahlgründungen auf Materialeffizienz, CO2-Reduktion und
  ...
  - type: featureTabs
    ...
    items:
      - label: Baugrundmodellierung
        body: >-
          Das System erzeugt aus Ihren Bohrdaten statistische Schichtmodelle. Statt sich
          auf ein einziges konservatives Profil zu stützen, erhalten Sie eine
          probabilistische Abbildung des Untergrunds, die die tatsächliche Streuung über
          Ihr Baufeld erfasst.
        points:
        ...
        image:
          ...
          alt: Luftaufnahme einer Baugrube mit Bohrgerät und arbeitenden Baggern
          width: 1024
          height: 576
      - label: Bemessungsoptimierung
        ...
        points:
          ...
          - Vergleich von Varianten mit Kosten- und Materialaufschlüsselung
        image:
          src: /assets/img/tab-design-optimization.webp
          alt: Tragwerksmodell eines Hochhauses auf seiner Pfahlgründung
          width: 1024
          height: 1024
      - label: CO2-Reduktion
        body: >-
          Jeder Kubikmeter Beton und jede Tonne Stahl hat einen CO2-Fußabdruck. Die
          Optimierung beziffert die CO2-Wirkung jeder Variante, damit Sie fundiert
          entscheiden können, wie Sie Tragverhalten und Nachhaltigkeitsziele
      ...
      - label: Normkonformität
        ...
        points:
          ...
          - Exportierbare Berechnungsberichte für Prüfung und Freigabe
        image:
          src: /assets/img/tab-code-compliance.webp
          alt: Die Empfehlungen EA-Pfähle, das Regelwerk, gegen das eine Gründung geprüft wird
          width: 380
          height: 722
          focus: top
  ...
  - type: faq
    tone: void
    title: >-
      Optimierte Gründungen, die Material sparen, CO2 senken und jede Normanforderung
      erfüllen.
    ...
    items:
      ...
      - q: Wie funktioniert die CO2-Berechnung?
        a: >-
          ...
          Herstellungsprozesse auf Basis veröffentlichter Ökobilanzdaten. Das System
          berechnet die graue Energie jeder Variante und stellt die Ergebnisse neben
          Tragverhalten und Kosten. So lassen sich Varianten in allen drei Dimensionen
          direkt vergleichen.
  ...
  - type: metricTiles
    ...
    body: >-
      Konservative Pfahlbemessung verschwendet Material und erhöht die CO2-Emissionen,
      weil sie an jedem Punkt vom ungünstigsten Fall ausgeht. Unser Ansatz nutzt echte
      Baugrunddaten statistisch, um Gründungen zu bemessen, die sicherer, schlanker und
      nachhaltiger sind.
    image:
      src: /assets/img/geo-engineers-bottom.webp
      alt: Rammgerät im Einsatz auf einer Baustelle neben einer fertigen Wohnanlage
      width: 1024
      height: 576
    items:
      - { value: 25%, label: Durchschnittliche Materialeinsparung bei optimierten Bemessungen }
      - { value: 40t CO2, label: Durchschnittliche CO2-Einsparung je Projekt }
    note: >-
      * Zahlen auf Basis von Pilotprojekten im Wohnungs- und Gewerbebau in Deutschland.
      Die tatsächlichen Ergebnisse hängen von Baugrundverhältnissen, Projektgröße und
      Randbedingungen der Bemessung ab.
  ...
  - type: pillars
    ...
    items:
      ...
      - title: Strategischer Vorsprung
        body:
          - >-
            Während andere Büros Pfähle noch anhand eines einzigen konservativen
      ...
      - title: Branchen-DNA
        body:
          - >-
            In unserem Team arbeiten Geotechniker und Softwareentwickler, die den
