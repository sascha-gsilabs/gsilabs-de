...
blocks:
  ...
  - type: statement
    id: intro
    title: >-
      Wo jahrzehntelanges Ingenieurwissen zur Grundlage von Automatisierung auf dem
      nächsten Niveau wird.
  ...
  - type: definitions
    ...
    items:
      - label: Automatisierung
        body: >-
          KI-gestützte Automatisierung für Ingenieurprozesse, von Entwurf und
          Detaillierung bis zur Fertigungsplanung.
      - label: Produkte
        body: >-
          Maßgeschneiderte Lösungen für die Bauwirtschaft, darunter
          Produktkonfiguratoren, Planungsassistenten und intelligente
          Vertriebswerkzeuge.
      - label: Befähigung
        body: >-
  ...
  - type: metrics
    ...
    note: >-
      Auf Basis abgeschlossener Projekte und laufender Mandate im Kundenportfolio von
      GSI Labs, 2023 bis 2026.

  - type: stages
    id: process
    title: Unser Vorgehen
    items:
      - title: Verstehen & Bewerten
        body: >-
          Wir analysieren Ihre bestehenden Abläufe, Ihre Datenlandschaft und die
          Fähigkeiten Ihres Teams, um die wirksamsten KI-Ansätze zu finden. Jedes
          Projekt beginnt mit einer klaren Rangfolge der Anwendungsfälle nach
  ...
  - type: pullQuote
    ...
    text: >-
      "Gemeinsam mit GSI haben wir für unseren Kunden einen schnelleren und
      reibungsloseren Fertigteilprozess erschlossen."
  ...
  - type: metrics
    ...
    note: >-
      Die Zahlen umfassen kumulierte Kundenprojekte und ausgerollte Lösungen von GSI
      Labs, Stand März 2026.
