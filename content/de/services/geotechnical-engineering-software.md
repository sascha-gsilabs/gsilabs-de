---
title: Software für Geotechnik
description: >-
  Wir bauen die Berechnungs- und Optimierungssoftware, mit der geotechnische Büros
  arbeiten, vom statistischen Baugrundmodell bis zur normkonformen Pfahlbemessung.
blocks:
  - type: hero
    eyebrow: Leistungen
    title: Software, die weiß, was ein Pfahl tut
    lede: >-
  ...
  - type: pillars
    ...
    title: >-
      Geotechnische Software scheitert an den Details. Am Baugrundmodell, an den
      Teilsicherheitsbeiwerten, an dem Anhang, der in einem Land gilt und im nächsten
      nicht.
    lede: >-
    ...
    items:
      - title: Statistische Baugrundmodelle
        body: >-
          Bohrdaten werden zu probabilistischen Schichtmodellen statt zu einem einzigen
          konservativen Profil, damit eine Bemessung gegen den Baugrund geprüft werden
          kann, wie er tatsächlich gemessen wurde.
      - title: Bemessungsoptimierung
        body: >-
          Rechenkerne, die tausende Konfigurationen gegen die Tragwerksanforderungen
          prüfen und die schlankste zurückgeben, die trägt, mitsamt der Begründung.
      - title: Normkonforme Ergebnisse
        body: >-
          Berechnungen nach EA Pfähle und Eurocode 7 mit den zugehörigen nationalen
          Anhängen, und eine Dokumentation, unter die ein Ingenieur seinen Namen setzen
          kann.
    note: >-
      * In Pilotprojekten in Deutschland lagen optimierte Bemessungen rund 25 Prozent
      leichter im Material. Was ein konkretes Projekt erreicht, hängt von den
      Baugrundverhältnissen und den Randbedingungen der Bemessung ab.
  ...
  - type: closer
    tone: void
    title: Eine Berechnung, die Ihre heutigen Werkzeuge nicht abbilden können?
    body: >-
